...
var INevellusSwapPair = _interopDefault(require('@nevellusswap/v2-core/build/INevellusSwapPair.json'));
...
var FACTORY_ADDRESS = '0xb1b5B3f949D03b251CA23Cb365F18CB32a87e70a';
var INIT_CODE_HASH = '0xa212ada5f8a301755224050fdb100651a51d2ee9c7818c205515f93df9e10cea';
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'NVLP', 'NevellusSwap LP');
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, INevellusSwapPair.abi, provider).getReserves()).then(function (_ref) {
