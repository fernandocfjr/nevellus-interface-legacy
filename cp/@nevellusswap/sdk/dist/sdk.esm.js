...
import INevellusSwapPair from '@nevellusswap/v2-core/build/INevellusSwapPair.json';
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, INevellusSwapPair.abi, provider).getReserves()).then(function (_ref) {
