...
import { ArbitrumMappingProvider } from '@nevellusswap/token-list-bridge-utils/src/providers/ArbitrumMappingProvider'
import { OptimismMappingProvider } from '@nevellusswap/token-list-bridge-utils/src/providers/OptimismMappingProvider'
import { PolygonMappingProvider } from '@nevellusswap/token-list-bridge-utils/src/providers/PolygonMappingProvider'
...
} from '@nevellusswap/token-list-bridge-utils/src/utils'
import ERC20Abi from '@nevellusswap/token-list-bridge-utils/src/abis/erc20'
