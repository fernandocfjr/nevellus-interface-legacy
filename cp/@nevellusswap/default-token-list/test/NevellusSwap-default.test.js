const packageJson = require('@NevellusSwap/default-token-list/package.json');
const schema = require('@NevellusSwap/token-lists/src/tokenlist.schema.json');
const { expect } = require('chai');
const { getAddress } = require('@ethersproject/address');
const Ajv = require('ajv');
const buildList = require('@NevellusSwap/default-token-list/src/buildList');
