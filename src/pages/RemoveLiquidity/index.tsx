...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@nevellusswap/sdk';
...
import { GreyCard, LightCardRemLiq } from '../../components/Card';
      ...
      <>
        <RowBetween>
          <Text color={theme.text2} fontWeight={500} fontSize={16}>
            {'NVLS ' + currencyA?.symbol + '/' + currencyB?.symbol} Burned
          </Text>
          <RowFixed>
